...
## Translation status (on April 15, 2016 - Branch Master)
...
| File                           | % done|
| ------------------------------ | --- |
| Menu_no.properties             | 100 |
| JabRef_no.properties           |  69 |
| Help files                     |   0 |
